...
for scene in "${scenes_1[@]}"; do
    ...
    # 训练
     CUDA_VISIBLE_DEVICES=0 python train_emd.py \
         -s /nvme0/zhouxiaoyu_copy/Occupancy/4dgs-jiayuang/GaussianPro-emd/euvs_data/trainset/level1/${scene} \
         -m /nvme0/zhouxiaoyu_copy/Occupancy/4dgs-jiayuang/GaussianPro-emd/output/level1/${scene} \
