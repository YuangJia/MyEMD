...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.propagated_iteration_begin = 2000
        self.propagated_iteration_after = 11000
        self.patch_size = 20
        self.pair_path = ''

        self.dynamic_thro = 7.5
