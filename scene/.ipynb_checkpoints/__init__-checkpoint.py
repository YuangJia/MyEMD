    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval,
                                                          sky_seg=args.sky_seg, load_normal=args.load_normal,
        ...
        if self.loaded_iter:
            ...
            # self.gaussians.create_from_anchor(os.path.join(args.source_path,"sparse/0","anchor_1.ply"))
...
class EUVSScene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        if self.loaded_iter:
            ...
            # self.gaussians.load_ply(os.path.join(self.model_path,
            #                                     "point_cloud",
            #                                     "sky_iteration_" + str(self.loaded_iter),
            #                                     "point_cloud.ply"))
            ...
            # self.gaussians.create_from_anchor(os.path.join(args.source_path, "sparse/0", "anchor_1.ply"),self.cameras_extent)
            self.gaussians.create_from_pcd(scene_info.point_cloud, self.cameras_extent)
    ...
    def getTrainCameraNum(self, scale=1.0):
        return len(self.train_cameras[scale])

    def getTrainCameraById(self, idx, scale=1.0):
